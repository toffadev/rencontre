...
<head>
    ...
    <title>{{ $profile->name }} attend votre réponse</title>
    ...
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden fade-in">
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-8 py-6">
                <h2 class="text-2xl font-bold text-white text-center">
                    {{ $profile->name }} attend votre réponse
                </h2>
                <div class="flex items-center justify-center mt-3">
                    <div class="w-2 h-2 bg-yellow-300 rounded-full animate-pulse mr-2"></div>
                    <span class="text-indigo-100 text-sm">Message en attente</span>
                </div>
            </div>
            ...
            <div class="px-8 py-8">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <p class="text-gray-700 leading-relaxed">
                                Vous avez lu le message de <span class="font-semibold text-indigo-600">{{ $profile->name }}</span> 
                                il y a <span class="font-medium">2 heures</span>, mais vous n'avez pas encore répondu.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mb-8">
                    <div class="inline-flex items-center bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-full px-6 py-3">
                        ...
                        <span class="text-green-800 font-medium">
                            {{ $profile->name }} attend avec impatience votre réponse !
                        </span>
                    </div>
                </div>
                ...
                <!-- Bouton CTA -->
                <div class="text-center mb-8">
                    <a href="{{ $url }}" class="btn-hover inline-flex items-center px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-full text-lg shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-indigo-300">
        ...
        <div class="text-center mt-8 fade-in">
            <p class="text-gray-600 mb-2">
                Merci,<br>
                <span class="font-semibold text-indigo-600">L'équipe {{ config('app.name') }}</span>
            </p>
            
            <!-- Social links ou autres infos -->
