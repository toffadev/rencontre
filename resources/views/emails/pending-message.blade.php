            ...
            <div class="px-8 py-8">
                <div class="mb-6">
                    <h3 class="text-xl font-semibold text-gray-800 mb-2">
                        Bonjour {{ $user->name ?? $notifiable->name }},
                    </h3>
                </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            <p class="text-gray-700 leading-relaxed">
                                Il y a <span class="font-semibold text-indigo-600">{{ $pendingMessagesCount }}</span> messages clients qui attendent une réponse.<br>
