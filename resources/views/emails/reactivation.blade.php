...
<head>
    ...
    <title>Vous nous manquez, {{ $user->name }} !</title>
    ...
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden fade-in">
            ...
            <div class="px-8 py-8">
                ...
                <div class="text-center mb-8">
                    <a href="{{ $url }}" class="btn-hover inline-flex items-center px-10 py-5 bg-gradient-to-r from-pink-500 to-purple-600 text-white font-bold rounded-full text-xl shadow-lg hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-pink-300">
        ...
        <div class="text-center mt-8 fade-in">
            <p class="text-gray-600 mb-2">
                Merci,<br>
                <span class="font-semibold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">L'équipe {{ config('app.name') }}</span>
            </p>
