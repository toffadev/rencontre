    ...
    <div class="w-full bg-white rounded-xl shadow-md p-4 mb-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <h2 class="text-xl font-semibold text-gray-800">
                <span class="text-pink-500">{{ filteredProfiles.length }}</span>
                profils à découvrir
            </h2>
        ...
        <div class="block lg:hidden">
            ...
            <div class="flex justify-end mb-4">
                <select
                    v-model="selectedFilter"
                    class="bg-pink-50 text-pink-600 rounded-lg px-3 py-1.5 border-none focus:ring-2 focus:ring-pink-500 transition-all duration-200 text-sm"
                >
                    <option value="all">Tous les profils</option>
                    <option value="online">En ligne</option>
                    <option value="new">Nouveaux</option>
            ...
            <div class="relative mb-6">
                <!-- Swipe Container -->
                <div
                    class="overflow-x-auto scrollbar-hide snap-x snap-mandatory flex space-x-3 pb-2"
                    ref="mobileCarousel"
                ...
                >
                    <div
                        ...
                        :key="profile.id"
                        class="snap-start flex-shrink-0 w-16 relative group cursor-pointer"
                    ...
                    >
                        ...
                        <div class="relative">
                            ...
                            <div
                                ...
                                class="absolute -top-1 -right-1 bg-pink-500 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center shadow-lg"
                            >
                        ...
                        <div class="mt-1 text-center">
                            <p
                                class="text-xs text-gray-700 font-medium truncate w-16"
                            >
                                {{ profile.name }}
                            </p>
                        </div>
                ...
                <!-- Navigation Arrows (optionnel, comme Messenger n'en a pas) -->
                <button
                    v-if="canScrollLeft"
                    @click="scrollMobile('left')"
                    class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 w-6 h-6 bg-white rounded-full shadow-lg flex items-center justify-center text-pink-500 hover:bg-pink-50 transition-all duration-200"
                >
                ...
                <button
                    ...
                    class="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 w-6 h-6 bg-white rounded-full shadow-lg flex items-center justify-center text-pink-500 hover:bg-pink-50 transition-all duration-200"
                >
        ...
        <div class="hidden lg:block">
            <div
                class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-6"
            >
                <div
                ...
                >
                    ...
                    <div class="aspect-[3/4] relative">
                        ...
                        >
                            ...
                            <div
                                class="flex items-center space-x-2 text-white/90 text-sm"
                            >
...
function updateScrollButtons() {
    ...
    currentScrollIndex.value = Math.round(
        scrollPercentage * (scrollIndicators.value.length - 1)
    );
}
